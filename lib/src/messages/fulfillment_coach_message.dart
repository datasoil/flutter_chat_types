...
@immutable
class FulFilmentCoach extends Message {
  ...
  FulFilmentCoach.fromJson(Map<String, dynamic> json)
  ...
  Map<String, dynamic> toJson() => {
        ...
        'text': text,
        'type': MessageType.coach_fulfillment.toShortString(),
        'updatedAt': updatedAt,
      };
